...
1. Execute `install.sql` no SQL Editor do Supabase.
2. Adicione o schema `learning` aos schemas expostos pela API.
3. Desative novos cadastros no Supabase Auth; a aplicacao e de uso pessoal.
